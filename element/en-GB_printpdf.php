...
function Header() {
	...
	$str =" Your ENERGY CLIMATE Label ";
	$str = utf8_decode($str);
	$this->Cell(110,10, ' '.$str.' ',0,1,'C');
	$this->Cell(146,40, ' Energy                                       Climate' ,0,1,'C');
...
function Footer() {
	...
	$this->Cell(0,0,'Energy and Climate label - http://lj01.cmoi.cc//modules/mod_DPEmaison',0,0,'C');

...
//1er rectangle
	...
	$this->Rect(2, 2, 145, 18, 'F');
		...
		$this->Cell(150,2,'Amount of conventional consumption   '.round($dpeprix,1).' Euro',0,1,'C');
...
//2è rectangle
	...
	$this->Rect(2, 20, 145, 30, 'F');
		...
		$conso="   Energy consumption                     Gas emissions greenhouse";
		$conso=utf8_decode($conso);
		$this->Cell(153,9,$conso,0,1,'C');
		$this->SetTextColor(150);
		$conso1="for heating, hot water";
...
//3è rectangle
	...
	$this->Rect(2, 50, 145, 20, 'F');
		$this->SetFont('Arial','B',12);
		$this->SetTextColor(100);
		$unit3 = "   Estimated consumption                     Conventional emissions ";
		$unit3 = utf8_decode($unit3);
	$this->Cell(140,12, ''.$unit3.'',0,1,'C');

		$unit1 = " kWhep / m².year ";	
  	$unit2 = " kg eqCo2 / m².year ";
...
//4è rectangle
	...
	$this->Rect(2, 70, 145, 137, 'F');
	 $unit4 = "Economic residence                           Low emissions ";
	 $unit4 = utf8_decode($unit4);
	 $this->Cell(112,60, ''.$unit4.'',0,1,'C');
	$unit5 = "Inefficient residence                          Strong emissions ";
...
function Footer() {
	...
	$this->Cell(0,0,'Energy and Climate Label - http://lj01.cmoi.cc/index.php/dpe-maison',0,0,'C');
